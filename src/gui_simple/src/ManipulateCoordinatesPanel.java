...
public class ManipulateCoordinatesPanel extends JPanel {
    ...
    public ManipulateCoordinatesPanel() {
        ...
        positionX = new JSlider(JSlider.HORIZONTAL, positionInPercent_Min, positionInPercent_Max, positionInPercent_Init);
        positionY = new JSlider(JSlider.HORIZONTAL, positionInPercent_Min, positionInPercent_Max, positionInPercent_Init);
        positionZ = new JSlider(JSlider.HORIZONTAL, positionInPercent_Min, positionInPercent_Max, positionInPercent_Init);
